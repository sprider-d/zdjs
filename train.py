...
if __name__ == "__main__":
    ...
    #   mobilenet
    #   xception
    #mobilenet比xception结构更轻量化,xception分割效果更好,更精确相对应需要更好的硬件和显存
    ...
    #------------------------------------------------------------------#
    VOCdevkit_path  = 'E:\daima\datasets\city_space'
    ...
    #   读取数据集对应的txt
    #---------------------------#
    with open(os.path.join(VOCdevkit_path, r"E:\daima\datasets\city_space\ImageSets\Segmentation\train.txt"),"r") as f:
        train_lines = f.readlines()
    with open(os.path.join(VOCdevkit_path, r"E:\daima\datasets\city_space\ImageSets\Segmentation\val.txt"),"r") as f:
